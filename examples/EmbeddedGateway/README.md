# EmbeddedGateway — embedding ConduitSharp as a library
...
```bash
dotnet run --project examples/EmbeddedGateway
# GET /hello         -> handled by the host app
# GET /health        -> forwarded upstream by YARP
curl -i localhost:6050/health
```
